...
export RUN_NAME="long_chain_reasoning"
export INPUT_JSONL="/fsx/jmanvi/Internship_project/ASD/data/benchmarks/By_split_phase_1/long_chain_reasoning_synthetic.jsonl"
