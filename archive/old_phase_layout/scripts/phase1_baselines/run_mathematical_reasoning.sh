...
export RUN_NAME="mathematical_reasoning"
export INPUT_JSONL="/fsx/jmanvi/Internship_project/ASD/data/benchmarks/By_split_phase_1/mathematical_reasoning_test.jsonl"
