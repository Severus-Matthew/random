...
export RUN_NAME="conversational_generation_sft"
export INPUT_JSONL="/fsx/jmanvi/Internship_project/ASD/data/benchmarks/By_split_phase_1/conversational_generation_test_sft.jsonl"
